                ...
                <div className='row'>
                  <div className='col-md-8'>
                    <div className='intro'>
                      <h2>Bize Ulas</h2>
                      <p>
                        Son teknoloji online sistem ile saniyeler icerisinde
                        uygun saatleri aratabilirsiniz.
                      </p>
                    </div>
                ...
                <div className='row articles'>
                  <div className='col-sm-6 col-md-4 item'>
                    ...
                    <p className='description'>
                      ...
                      varius finibus est, interdum justo suscipit id.
                    </p>
                ...
                <div className='post-preview'>
                  <a href='#'>
                    <h2 className='post-title'>
                      Alanda teknik gelisme ile ameliyat sonrasi iyilesme
                      hizinda artis yasandi.
                    </h2>
                    ...
                    <section className='highlight-blue'>
                      <div className='container'>
                        <div className='intro'>
                          ...
                          <p className='text-center'>
                            Nunc luctus in metus eget fringilla. Aliquam sed
                            justo ligula. Vestibulum nibh erat, pellentesque ut
                            laoreet vitae.
                          </p>
                        </div>
